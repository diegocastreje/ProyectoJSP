                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item">
                              <a class="nav-link active" style="background: #dddddd" aria-current="true" href="${pageContext.request.contextPath}/ServletControlador?accion=goGrupos">Grupos</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" style="color:black" href="${pageContext.request.contextPath}/ServletControlador?accion=goGeneros">Generos</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <tbody>
                            <c:forEach var="grupo" items="${grupos}" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/ServletControlador?accion=editarGrupo&id_grupo=${grupo.id_grupo}"
            ...
            <div class="col-md-3">               
                <div class="card text-center text-dark mb-3" style="background: #f8f1f1">
                    <div class="card-body">
                        <h3>Total Grupos</h3>
                        <h4 class="display-4">
                            <i class="fas fa-users"></i>${totalGrupos}
                        </h4>
                    </div>
                </div>         
            </div>
